...
- **Data Latency:** What is the best architectural approach to technically implement the fastest API data retrieval to ensure first-class ground truth data?

## 5. Example Mockup Pool Viewer
Based on our knowledge and our ideas we have designed a mockup of the **Pool Viewer**:
<div align="center">
  <img src="assets/img/pool_viewer_mockup.svg" alt="Pool Viewer Mockup" width="80%" />
</div> 
